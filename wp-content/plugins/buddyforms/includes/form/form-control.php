...
function buddyforms_process_submission( $args = array() )
{
    ...
    if ( !is_wp_error( $post_id ) && !empty($post_id) ) {
        ...
        $post_title = apply_filters(
            ...
            ( isset( $_POST['buddyforms_form_title'] ) && !empty($_POST['buddyforms_form_title']) ? stripslashes( $_POST['buddyforms_form_title'] ) : 'none' ),
            $form_slug,
            $post_id
        );
        $bf_post = array(
            ...
            'buddyforms_update_form_content',
            ( isset( $_POST['buddyforms_form_content'] ) && !empty($_POST['buddyforms_form_content']) ? $_POST['buddyforms_form_content'] : '' ),
            $form_slug,
            $post_id
        ),
            'post_status'    => $post_status,
